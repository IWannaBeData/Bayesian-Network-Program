...
- Added **Highlight Selected**, **Highlight All**, and **Clear Highlights** to quickly emphasize/reset the diagram.
- Keyboard shortcuts: **V** = Select, **A** = Draw Arrow, **H** = Highlight tool, **M** = Highlight selected.
